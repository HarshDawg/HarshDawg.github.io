...
<head>
	...
	<style type="text/css">
        ...
        form { width:440px; height: 290px;margin:0px auto; background-color: #EAFDCF;}
...
<form id="form0" method="post" action="doUpdateCar.php">
	<fieldset>
		<!---Creates the form for Cars to update it --->
		<legend>Update Assign06Cars table</legend>
        <ul>
            <li><label title="CarID" for="CarIDdis">Car ID</label>
            	<input name="CarIDdis" id="CarIDdis" type="text" size="20" maxlength="20"  value="<?php if($num_results != 0) {echo( trim($row["CarID"]));} ?>" disabled="disabled"/>
            	<input name="carID" id="carID" type="hidden" value="<?php if($num_results != 0) {echo( trim($row["CarID"]));} ?>"/>
            </li>
            ...
            <li>
                ...
                <input name="carModel" id="carModel" type="text" size="20" maxlength="30" value="<?php if($num_results != 0){echo(trim($row["CarModel"]));} ?>"/>
            </li>
            ...
            <li><label title="CarYear" for="carYear">Year</label>
                ...
                <option value="1973" <?php if(($num_results != 0) && (trim($row["CarYear"])) == "1972") {echo("selected = 'selected'");} ?>>1973</option>
            ...
            <li>
                ...
                <input name="carColor" id="carColor" type="text" size="20" maxlength="30" value="<?php if($num_results != 0){echo(trim($row["CarColor"]));} ?>"/>
            </li>
